...
\section{Data Path Organization}
    ...
    \section{Design Source Code}
        ...
        \lstinputlisting{../source/Design/reg_pipe_stage_a.sv}
        \lstinputlisting{../source/Design/reg_pipe_stage_b.sv}
    ...
    \section{Verification Source Code}
        ...
        \lstinputlisting{../source/Verif/tb_class_def.sv}
        \lstinputlisting{../source/Verif/tb_utils_pkg.sv}
    
    \section{Build Scripts and utilities}
        \lstinputlisting[language = bash, label = imuangle]{../runsim.sh}
        \lstinputlisting[label = imuangle]{../vlogan_args.list}
        \lstinputlisting[label = imuangle]{../VCS_args.list}
